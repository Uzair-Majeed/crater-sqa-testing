...
use Tests\TestCase; // Import the base TestCase

uses(TestCase::class); // This makes Laravel's testing helpers (like mock()) available
...
// The afterEach hook is often automatically handled by TestCase's tearDown method
// when using uses(TestCase::class). Keeping it here is harmless.
afterEach(function () {
    Mockery::close();
});
