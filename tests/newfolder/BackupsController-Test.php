...
test('index method returns a list of backups and disks on success', function () {
    ...
    // Mock BackupDestination::create static method using alias
    ...
    $backup1->shouldReceive('size')->andReturn(50 * 1024 * 1024)->once();
    ...
    $backup2->shouldReceive('size')->andReturn(100 * 1024 * 1024)->once();
