...
test('index method authorizes, fetches and returns items with default limit and meta', function () {
    ...
    Item::shouldReceive('whereCompany')
        ->once()
        ->ordered()
    ...
    TaxType::shouldReceive('whereCompany')
        ->once()
    ...
    Mockery::mock('alias:' . ItemResource::class);
    ItemResource::shouldReceive('collection')
        ->once()
