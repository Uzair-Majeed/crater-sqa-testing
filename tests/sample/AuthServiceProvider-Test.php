...
beforeEach(function () {
    ...
    // Swap Gate facade binding to a mock so calls are intercepted,
    // fixing Mockery exception about duplicate class loading.
    $this->gateMock = Mockery::mock();
    app()->instance('Illuminate\Contracts\Auth\Access\Gate', $this->gateMock);
});
